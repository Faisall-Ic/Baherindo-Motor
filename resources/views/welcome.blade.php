...
@section('title','Osis Motor')

@section('content')
    <div class="absolute w-full h-screen -mt-50 -z-1 overflow-hidden">
  <!-- Video Background -->
  <video autoplay muted loop class="absolute w-full h-240 object-cover opacity-80 object-top ">
    <source src="/storage/video/bg-loop.mp4" type="video/mp4" />
    Your browser does not support the video tag.
  </video>

  <!-- Konten di atas video -->
  <div class="relative z-10 flex items-center justify-center h-full text-white bg-black/40">
    <h1 class="text-4xl md:text-6xl font-bold">Welcome to Osis Motor</h1>
  </div>
</div>
            ...
            <div class="w-full justify-start items-center gap-12 grid lg:grid-cols-2 grid-cols-1">
                <div
                    ...
                    <div class="pt-24 lg:justify-center sm:justify-end justify-start items-start gap-2.5 flex">
                        <img class=" rounded-xl object-cover" src="/storage/image/about1.jpg" alt="about Us image" />
                    </div>
            ...
            <div class="lg:mb-0 mb-10">
                <div class="group w-full h-full">
                    <div class="relative h-full">
                        <img src="/storage/image/contact.jpg" alt="ContactUs tailwind section" class="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-700 object-cover"/>
                        <h1 class="font-manrope text-white text-4xl font-bold leading-10 absolute top-20 left-11">Contact us</h1>
                        <div class="absolute bottom-0 w-full lg:p-11 p-5">
                            <div class="bg-white rounded-lg p-6 block">
                                <a href="javascript:;" class="flex items-center mb-6">
                                    ...
                                    <h5 class="text-black text-base font-normal leading-6 ml-5">0857-000-021</h5>
                                </a>
                                <a href="javascript:;" class="flex items-center mb-6">
                                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
